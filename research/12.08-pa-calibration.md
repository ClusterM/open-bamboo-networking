...
| Per-tray PA fields in `push_status` ([§12.1](12.01-status.md#ams--filament-in-push_status)) | `cali_idx` only (absent on empty trays) | `k`, `n` |
...
When Studio submits a print job via `project_file` ([§8.8.1](08.08-print-abi.md#project_file-payload)), two fields control PA behavior:
